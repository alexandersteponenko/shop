...
})({"aHUMs":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "ec6893e7195a0566";
"use strict";
...
},{}],"hfvhc":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _utilsJs = require("./utils.js");
var _app = require("firebase/app");
var _firestore = require("firebase/firestore");
var _line2Svg = require("../image/Line 2.svg");
var _line2SvgDefault = parcelHelpers.interopDefault(_line2Svg);
var _vectorSvg = require("../image/Vector.svg");
var _vectorSvgDefault = parcelHelpers.interopDefault(_vectorSvg);
...
async function getProduct(productId) {
    const productRef = (0, _firestore.doc)(db, "products", productId);
    const productSnap = await (0, _firestore.getDoc)(productRef);
...
function displayProductDetails(product) {
    ...
    if (!product) {
        (0, _utilsJs.showErrorMessage)((0, _utilsJs.ERROR_NO_PRODUCT));
        return;
    }
    wrapperCard.innerHTML = `
  <div class="card__content" product-card-id="${product.id}">
            <div class="card__image">
                <div class="card__image-wrapper">
                    <img src="${product.imageURL}" alt="${product.model}" class="card__image-product" />
                </div>
            </div>
            <div class="card__information">
                <h1>${product.model}</h1>
                <h4 class="series">${product.series}</h4>
                <div class="rating">
                    <img src="${product.rating}" alt="\u{438}\u{43A}\u{43E}\u{43D}\u{43A}\u{430} \u{440}\u{435}\u{439}\u{442}\u{438}\u{43D}\u{433}\u{430}" />
                </div>
                <div class="price">$ ${product.price.toFixed(2)}</div>
                <p class="text">${product.description}</p>
                <div class="card__btn-wrapper">
                    <button class="add__btn" id="addToCartBtn">
                        <img src="${0, _vectorSvgDefault.default}" />\u{412} \u{43A}\u{43E}\u{440}\u{437}\u{438}\u{43D}\u{443}
                    </button>
                </div>
            </div>
        </div>
        <div class="card__line">
            <img src="${0, _line2SvgDefault.default}" alt="\u{438}\u{43A}\u{43E}\u{43D}\u{43A}\u{430} \u{43B}\u{438}\u{43D}\u{438}\u{438}" />
        </div>
        <div class="card__description">
            <h4>\u{41E}\u{43F}\u{438}\u{441}\u{430}\u{43D}\u{438}\u{435}</h4>
...
function addToCart(product) {
    ...
    if (existingProductIndex > -1) // Если товар уже в корзине, увеличиваем количество
    savedCart[existingProductIndex].quantity += 1;
    else // Если товара еще нет в корзине, добавляем его
    savedCart.push({
        ...product,
        quantity: 1
    });
    ...
    // Обновляем список изображений в корзине
    updateBagList();
}
...
// Загрузка и отображение товара при загрузке страницы
window.onload = async ()=>{
...
},{"./utils.js":"72Dku","firebase/app":"aM3Fo","firebase/firestore":"8A4BC","../image/Line 2.svg":"5GSwO","../image/Vector.svg":"84Fwg","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"72Dku":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"../image/ic-Vector.svg":"go0iV","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"go0iV":[function(require,module,exports,__globalThis) {
module.exports = require("6b7e90d1ff606faa").getBundleURL('kioBO') + "ic-Vector.67128207.svg" + "?" + Date.now();

},{"6b7e90d1ff606faa":"lgJ39"}],"lgJ39":[function(require,module,exports,__globalThis) {
"use strict";
var bundleURL = {};
...
},{}],"5GSwO":[function(require,module,exports,__globalThis) {
module.exports = require("9201abbbfd52f836").getBundleURL('kioBO') + "Line 2.a7b3b014.svg" + "?" + Date.now();

},{"9201abbbfd52f836":"lgJ39"}],"84Fwg":[function(require,module,exports,__globalThis) {
module.exports = require("ab8866fdebb53d82").getBundleURL('kioBO') + "Vector.82e5190c.svg" + "?" + Date.now();

},{"ab8866fdebb53d82":"lgJ39"}]},["aHUMs","hfvhc"], "hfvhc", "parcelRequire94c2")

//# sourceMappingURL=card.195a0566.js.map
